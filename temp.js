...
// We need you to create a basic UI to display the show names and a few details about it 
// (you can choose what you want to display along with the show name). 
// Include a button for each of the shows to redirect the user to another screen that shows the summary 
// of the particular show. (Refer to the api structure. You will find a summary section for each show there.). 
// We need you to complete this assignment and upload it to a GitHub Repository marked as Public
//  and email us back the link to the repository (check the contact section for the email address).
